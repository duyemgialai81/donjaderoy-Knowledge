...
import com.example.the_autumn.security.JwtTokenProvider; // Import cần thiết
...
public class AuthServiceImpl implements AuthService {
    ...
    @Autowired
    private com.example.the_autumn.repository.DeviceRepository deviceRepository;
    ...
    public ResponseObject login(AuthDTO authDTO) {
        ...
        if (registerDTO.getDeviceId() == null && (registerDTO.getDeviceName() != null || registerDTO.getUserAgent() != null)) {
            var device = com.example.the_autumn.entity.Device.builder()
                    .id(UUID.randomUUID().toString())
                    .userId(user.getId())
